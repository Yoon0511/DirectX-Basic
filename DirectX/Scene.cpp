...
{
	ID3D12RootSignature* pd3dGraphcisRootSignature = NULL;
	...
	pd3dDevice->CreateRootSignature(0, pd3dSignatureBlob->GetBufferPointer(), pd3dSignatureBlob->GetBufferSize(), __uuidof(ID3D12RootSignature), (void**)&pd3dGraphcisRootSignature);

	if (pd3dSignatureBlob) pd3dSignatureBlob->Release();
	if (pd3dErrorBlob) pd3dErrorBlob->Release();

	return pd3dGraphcisRootSignature;
}
...
void CScene::BuildObjects(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	XMFLOAT3 xmf3Scale(2.0f, 3.0f, 2.0f);
	...
	m_pTerrain = new CHeightMapTerrain(pd3dDevice, pd3dCommandList,
		m_pd3dGraphicsRootSignature, _T("terrain2.raw"), 2049, 2049, 2049, 2049, xmf3Scale, xmf4Color);
#endif
